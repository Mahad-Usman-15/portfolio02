...
export default function Projects() {
  return (
    <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-4 p-3">
      {data.map((proj) => (
        <div
          key={proj.id}
          className="bg-white shadow-[0_4px_8px_-3px_rgba(0,0,0,0.3)] border p-2 w-full max-w-[200px] sm:max-w-[220px] rounded-lg font-[sans-serif] overflow-hidden mx-auto mt-3"
        >
